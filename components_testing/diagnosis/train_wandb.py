...
def trainer(args: Namespace):
    ...
    # tokenizer.model_max_length = model.bert.embeddings.position_embeddings.num_embeddings # NOTE: for setting correct embedding length 
    ...
    wandb.summary["best_acc"] = best_acc # TODO: modify this line
...
if __name__ == "__main__":
    ...
    hparams = ["encoder", "fc", "optimizer", "lr", "nepochs", "bs", "fold", "remainder"]
    ...
    for lr in [2e-5, 3e-5, 4e-5]:
        for r in range(10):
            ...
            wandb.init(
                project="icda_dx",
                name=f"{args.encoder}_{args.optimizer}_lr-{args.lr}_r-{args.remainder}",
